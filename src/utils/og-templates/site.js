  ...
  return satori(
    {
      ...
      props: {
        style: {
          ...
          backgroundImage: "radial-gradient(circle at 25px 25px, #1e293b 2%, transparent 0%), radial-gradient(circle at 75px 75px, #1e293b 2%, transparent 0%)", // Patrón sutil de puntos (opcional, si no te gusta bórralo)
